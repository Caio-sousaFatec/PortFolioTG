   ...
   ![Demonstração de wireframe](assets/evidencia_07.png) 

   </details>

   ## Conhecimentos Obtidos

   Durante o desenvolvimento deste projeto, aprofundei meu domínio em Java e na criação de interfaces utilizando JavaFX, compreendendo de forma mais clara a integração entre frontend e backend. Obtive experiência prática no fluxo de lançamento e aprovação de registros, bem como no uso de ferramentas como Figma, NetBeans, SceneBuilder e GitHub para organização e suporte ao desenvolvimento. Além disso, aprimorei minha atuação em metodologias ágeis, participando das etapas de planejamento, acompanhamento e validação das entregas do time.
